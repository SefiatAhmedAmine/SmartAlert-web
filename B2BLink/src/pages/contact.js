  ...
  return (
    <MainLayout>
        <div className="contact-page pt-100 mb-100">
            ...
            <div className="row g-4 mb-100">
                ...
                <div className="section-title mb-50">
                    <h4>Contactez-Noux avec une Ligne d'Assistance</h4>
                </div>
                <div className="single-contact mb-40">
                    ...
                    <span>Nous Contacter par Boite Email</span>
                    <h6><a href="mailto:contact@b2blink.ma">contact@b2blink.ma</a></h6>
                    </div>
                </div>
                <div className="single-contact">
                    ...
                    <h6><a>3409, Lotissement Wifaq, Temara, Maroc</a></h6>
                    </div>
                </div>
                <div className="service-available">
                    <span>N:B:</span>
                    <p>Le Service Clientèle est toujours ouvert de <strong>9h</strong> à <strong>18h</strong> tous les jours.</p>
                </div>
                </div>
                ...
                <div className="inquiry-form">
                    ...
                    <div className="row">
                        ...
                        <div className="form-inner mb-30">
                            ...
                            <input type="text" placeholder="Ex- +212-06********" />
                        </div>
                        </div>
                        <div className="col-md-6">
                        <div className="form-inner mb-30">
                        ...
                        <div className="form-inner mb-30">
                            <label>Objet*</label>
                            <input type="email" placeholder="Objet" />
                        </div>
                        </div>
                        <div className="col-md-12">
                        <div className="form-inner mb-30">
                            <label>Notes Brèves*</label>
                            <textarea placeholder="Vos Notes Brèves..." defaultValue={""} />
                        </div>
                        </div>
                        <div className="col-md-12">
                        <div className="col-md-12">
                            <div className="form-inner">
                            <button type="submit" className="primary-btn3">Soumettre Maintenant</button>
                            </div>
                        </div>
                        </div>
                    </div>
        ...
        <div className="contact-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d26484.615950485844!2d-6.923973!3d33.926285!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda70d632425af8b%3A0x9bd9677657223979!2sWIFAQ%20II%2C%20T%C3%A9mara%2C%20Maroc!5e0!3m2!1sfr!2sfr!4v1688754519357!5m2!1sfr!2sfr" style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
        </div>
    </MainLayout>
  )
}
