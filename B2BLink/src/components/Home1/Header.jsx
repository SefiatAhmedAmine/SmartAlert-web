        ...
        <ul className="menu-list">
            ...
            {/* <div className={`mega-menu ${state.activeMenu === "new-car" ? "d-block" : ""}`}>
              <ul className="menu-row">
                ...
                <li className="menu-single-item">
                  ...
                  <ul>
                    <li>
                      <Link href="/single-brand-category">Toyota Camry</Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">Ford Mustang</Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">Volkswagen Golf</Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">Mercedes C-Class</Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">Audi A4</Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">Jeep Wrangler</Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">Mazda CX-5</Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">Chevrolet Corvette</Link>
                    </li>
                    <div className="explore-more-btn">
                      <Link href="/brand-category">
                        Explore More <i className="bi bi-arrow-right" />
                ...
                <li className="menu-single-item">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link href="/single-brand-category">
                        Melbourne City (10)
                        <img src="assets/img/menu-icon/melbourne.svg" alt="" />
                      </Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">
                    ...
                    <li>
                      <Link href="/single-brand-category">
                        Menchester City (10)
                        <img src="assets/img/menu-icon/menchester.svg" alt="" />
                      </Link>
                    </li>
                    <li>
                      <Link href="/single-brand-category">
          ...
          {/* <li className="menu-item-has-children">
            ...
            <i
              ...
              className={`bi bi-${state.activeMenu === "pages" ? "dash" : "plus"} dropdown-icon`}
            />
            <ul className={`sub-menu ${state.activeMenu === "pages" ? "d-block" : ""}`}>
              <li>
                <Link href="/brand-category">Categories</Link>
              </li>
              <li>
                <Link href="/single-brand-category">Single Brand Category</Link>
              </li>
              <li>
                <Link href="/car-listing-left-sidebar?condition=used">VOITURES D'OCCASION</Link>
              </li>
              <li>
                <Link href="/car-listing-left-sidebar?condition=new">VOITURES NEUVES</Link>
              </li>
              <li>
                ...
                <i
                  ...
                  className={`d-lg-none d-flex bi bi-${state.activeSubMenu === "submenu1" ? "dash" : "plus"} dropdown-icon`}
                />
                <ul className={`sub-menu ${state.activeSubMenu === "submenu1" ? "d-block" : ""}`}>
                  <li>
                    <Link href="/car-listing-left-sidebar">Car Listing Left Sidebar</Link>
                  </li>
                  <li>
                    <Link href="/car-listing-right-sidebar">Car Listing Right Sidebar</Link>
                  </li>
                  <li>
                    <Link href="/car-listing-no-sidebar">Car Listing No Sidebar</Link>
                  </li>
                </ul>
              </li>
            </ul>
