...
function index() {
  const options = ['100000 - 250000 MAD',' 5 - 10 lakh', '10 - 15 lakh', '15 - 20 lakh'];
            ...
            <div className="col-xxl-8 col-xl-7 d-flex align-items-center wow fadeInUp" data-wow-delay="200ms">
              ...
              <span className={`sub-title ${styles.subtitle}`}>
                Performance et Rapidité Exceptionnelles
                  <svg width={30} height={23} viewBox="0 0 30 23" className={styles.svgBlack} xmlns="http://www.w3.org/2000/svg">
